        ...
        <div class="col-xl-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">Promotion Add</h4>
                </div><!-- end card header -->
                ...
                <div class="card-body">
                    ...
                    <!--PAGE CONTENT BEGINS-->
                    <form action="{{ route('admin.promotions.store') }}" accept-charset="utf-8" method="post"
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6">
                                ...
                                @endif
                                <br><div id="promotionSection" style="display:none">
                                    <span style="color: #ff1f1f">⚠ This course has an active promotion!</span>&nbsp; <span id="discountType" class="badge bg-success"></span>
                                    <button id="deactivatePromotionBtn" class="btn btn-danger btn-sm">Deactivate Old Promotion</button>
                                </div>
                            </div>
                        </div> 
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6">
                                <select class="form-select" id="discount_type" name="discount_type">
                                    ...
                                    <option value="timer">Timer Discount</option>
                                    <option value="first_some_student">First Number of Student</option>
                        ...
                        <div class="row mb-3" id="timer_fields" style="display:none">
                        ...
                        <div class="row mb-3" id="student_limit_fields" style="display: none;">
                            <div class="col-lg-2 custom-text-align hide_field" style="border-radius: 20px 0px 0px 20px;">
                        ...
                        <div class="row mb-3" id="special_day_fields" style="display:none">
                            <div class="col-lg-2 custom-text-align hide_field" style="border-radius: 20px 0px 0px 20px;">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input type="number" class="form-control" id="discount_value" maxlength="8" step="0.01" name="discount_value"
                                placeholder="Enter discount percentage (e.g., 20 for 20%)" required>
...
<script>
    ...
    document.getElementById('discount_type').addEventListener('change', function () {
        ...
        // Clear all input values when "None" is selected
        if (type === 'null') {
            // Hide all fields
            timerFields.style.display = 'none';
            studentLimitFields.style.display = 'none';
            specialDayFields.style.display = 'none';

            // Clear field values
            document.getElementById('start_time').value = '';
            document.getElementById('end_time').value = '';
            document.getElementById('student_limit').value = '';
            document.getElementById('day_title').value = '';
...
<script>
    $(document).ready(function () {
        $('#course_id').change(function () {
            ...
            if (courseId) {
                $.ajax({
                    url: `/admin/check-promotion/${courseId}`,
                    type: 'GET',
                    success: function (response) {
                        if (response.promotion) {
                            $('#promotionSection').show();
                            $('#discountType').text(response.promotion.discount_type);
                            $('#deactivatePromotionBtn').data('course-id', courseId);
                        } else {
        ...
        $('#deactivatePromotionBtn').click(function () {
            let courseId = $(this).data('course-id');
            if (courseId) {
                $.ajax({
                    url: `/admin/promotions/deactivate-old`,
                    type: 'POST',
                    data: { 
                        _token: '{{ csrf_token() }}', 
                        course_id: courseId 
